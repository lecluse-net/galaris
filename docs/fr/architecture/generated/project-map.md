...
- 521 arêtes de dépendance backend ;
...
- 567 handlers HTTP/WebSocket détectés ;
...
| GET | `/evaluation/candidates` | `app.lab` | `read_candidates` | oui | `back/app/lab/router.py:172` |
| GET | `/evaluation/config` | `app.lab` | `read_config` | oui | `back/app/lab/router.py:166` |
| GET | `/evaluation/dispatcher/candidates` | `app.lab` | `read_dispatcher_candidates` | oui | `back/app/lab/router.py:334` |
| DELETE | `/evaluation/dispatcher/cases/{case_id}` | `app.lab` | `delete_dispatcher_case` | oui | `back/app/lab/router.py:379` |
| PATCH | `/evaluation/dispatcher/cases/{case_id}` | `app.lab` | `update_dispatcher_case` | oui | `back/app/lab/router.py:368` |
| POST | `/evaluation/dispatcher/cases/{case_id}/duplicate` | `app.lab` | `duplicate_dispatcher_case` | oui | `back/app/lab/router.py:390` |
| POST | `/evaluation/dispatcher/cases/{case_id}/generate-expected` | `app.lab` | `generate_dispatcher_expected` | oui | `back/app/lab/router.py:419` |
| POST | `/evaluation/dispatcher/cases/{case_id}/restore-source` | `app.lab` | `restore_dispatcher_case` | oui | `back/app/lab/router.py:399` |
| GET | `/evaluation/dispatcher/datasets` | `app.lab` | `read_dispatcher_datasets` | oui | `back/app/lab/router.py:252` |
| POST | `/evaluation/dispatcher/datasets` | `app.lab` | `create_dispatcher_dataset` | oui | `back/app/lab/router.py:262` |
| DELETE | `/evaluation/dispatcher/datasets/{dataset_id}` | `app.lab` | `delete_dispatcher_dataset` | oui | `back/app/lab/router.py:301` |
| PATCH | `/evaluation/dispatcher/datasets/{dataset_id}` | `app.lab` | `update_dispatcher_dataset` | oui | `back/app/lab/router.py:270` |
| GET | `/evaluation/dispatcher/datasets/{dataset_id}/cases` | `app.lab` | `read_dispatcher_cases` | oui | `back/app/lab/router.py:308` |
| POST | `/evaluation/dispatcher/datasets/{dataset_id}/cases` | `app.lab` | `create_dispatcher_case` | oui | `back/app/lab/router.py:321` |
| POST | `/evaluation/dispatcher/datasets/{dataset_id}/cases/from-task` | `app.lab` | `import_dispatcher_case` | oui | `back/app/lab/router.py:352` |
| GET | `/evaluation/dispatcher/datasets/{dataset_id}/runs` | `app.lab` | `read_dispatcher_runs` | oui | `back/app/lab/router.py:447` |
| POST | `/evaluation/dispatcher/datasets/{dataset_id}/runs` | `app.lab` | `start_dispatcher_run` | oui | `back/app/lab/router.py:436` |
| GET | `/evaluation/dispatcher/runs/{run_id}` | `app.lab` | `read_dispatcher_run` | oui | `back/app/lab/router.py:459` |
| POST | `/evaluation/dispatcher/runs/{run_id}/analyze` | `app.lab` | `analyze_dispatcher_run` | oui | `back/app/lab/router.py:468` |
| POST | `/evaluation/dispatcher/runs/{run_id}/cancel` | `app.lab` | `cancel_dispatcher_run` | oui | `back/app/lab/router.py:481` |
| GET | `/evaluation/executor-prompts/defaults` | `app.lab` | `read_executor_prompt_defaults` | oui | `back/app/lab/router.py:496` |
| GET | `/evaluation/mechanisms` | `app.lab` | `read_mechanisms` | oui | `back/app/lab/router.py:502` |
| PATCH | `/evaluation/memory_extraction/datasets/{dataset_id}/configuration` | `app.lab` | `update_memory_extraction_dataset_configuration` | oui | `back/app/lab/router.py:603` |
| GET | `/evaluation/memory_extraction/prompt-default` | `app.lab` | `read_memory_extraction_prompt_default` | oui | `back/app/lab/router.py:286` |
| PATCH | `/evaluation/planner/datasets/{dataset_id}/configuration` | `app.lab` | `update_planner_dataset_configuration` | oui | `back/app/lab/router.py:622` |
| GET | `/evaluation/planner/prompt-default` | `app.lab` | `read_planner_prompt_default` | oui | `back/app/lab/router.py:295` |
| GET | `/evaluation/tasks` | `app.lab` | `read_lab_tasks` | oui | `back/app/lab/router.py:186` |
| POST | `/evaluation/tasks` | `app.lab` | `add_lab_task` | oui | `back/app/lab/router.py:197` |
| DELETE | `/evaluation/tasks/{task_id}` | `app.lab` | `remove_lab_task` | oui | `back/app/lab/router.py:212` |
| POST | `/evaluation/tasks/{task_id}/analyze` | `app.lab` | `analyze_task` | oui | `back/app/lab/router.py:236` |
| GET | `/evaluation/tasks/{task_id}/diagnoses` | `app.lab` | `read_task_diagnoses` | oui | `back/app/lab/router.py:223` |
| POST | `/evaluation/topic-classification/datasets/{dataset_id}/cases/from-message-range` | `app.lab` | `import_topic_messages` | oui | `back/app/lab/router.py:565` |
| PATCH | `/evaluation/topic-classification/datasets/{dataset_id}/configuration` | `app.lab` | `update_topic_dataset_configuration` | oui | `back/app/lab/router.py:584` |
| GET | `/evaluation/topic-classification/message-agents` | `app.lab` | `read_topic_message_agents` | oui | `back/app/lab/router.py:511` |
| GET | `/evaluation/topic-classification/message-people` | `app.lab` | `read_topic_message_people` | oui | `back/app/lab/router.py:521` |
| GET | `/evaluation/topic-classification/message-preview` | `app.lab` | `preview_topic_messages` | oui | `back/app/lab/router.py:535` |
| GET | `/evaluation/{mechanism}/candidates` | `app.lab` | `read_mechanism_candidates` | oui | `back/app/lab/router.py:734` |
| DELETE | `/evaluation/{mechanism}/cases/{case_id}` | `app.lab` | `delete_mechanism_case` | oui | `back/app/lab/router.py:856` |
| PATCH | `/evaluation/{mechanism}/cases/{case_id}` | `app.lab` | `update_mechanism_case` | oui | `back/app/lab/router.py:838` |
| POST | `/evaluation/{mechanism}/cases/{case_id}/duplicate` | `app.lab` | `duplicate_mechanism_case` | oui | `back/app/lab/router.py:870` |
| POST | `/evaluation/{mechanism}/cases/{case_id}/generate-expected` | `app.lab` | `generate_mechanism_expected` | oui | `back/app/lab/router.py:912` |
| POST | `/evaluation/{mechanism}/cases/{case_id}/restore-source` | `app.lab` | `restore_mechanism_case` | oui | `back/app/lab/router.py:887` |
| GET | `/evaluation/{mechanism}/datasets` | `app.lab` | `read_mechanism_datasets` | oui | `back/app/lab/router.py:641` |
| POST | `/evaluation/{mechanism}/datasets` | `app.lab` | `create_mechanism_dataset` | oui | `back/app/lab/router.py:656` |
| DELETE | `/evaluation/{mechanism}/datasets/{dataset_id}` | `app.lab` | `delete_mechanism_dataset` | oui | `back/app/lab/router.py:685` |
| PATCH | `/evaluation/{mechanism}/datasets/{dataset_id}` | `app.lab` | `update_mechanism_dataset` | oui | `back/app/lab/router.py:667` |
| GET | `/evaluation/{mechanism}/datasets/{dataset_id}/cases` | `app.lab` | `read_mechanism_cases` | oui | `back/app/lab/router.py:698` |
| POST | `/evaluation/{mechanism}/datasets/{dataset_id}/cases` | `app.lab` | `create_mechanism_case` | oui | `back/app/lab/router.py:716` |
| POST | `/evaluation/{mechanism}/datasets/{dataset_id}/cases/from-execution` | `app.lab` | `import_executor_execution_case` | oui | `back/app/lab/router.py:812` |
| POST | `/evaluation/{mechanism}/datasets/{dataset_id}/cases/from-source` | `app.lab` | `import_mechanism_case` | oui | `back/app/lab/router.py:757` |
| POST | `/evaluation/{mechanism}/datasets/{dataset_id}/cases/from-task` | `app.lab` | `import_mechanism_task_case` | oui | `back/app/lab/router.py:787` |
| POST | `/evaluation/{mechanism}/datasets/{dataset_id}/preview` | `app.lab` | `preview_lab_input` | oui | `back/app/lab/router.py:113` |
| GET | `/evaluation/{mechanism}/datasets/{dataset_id}/runs` | `app.lab` | `read_mechanism_runs` | oui | `back/app/lab/router.py:955` |
| POST | `/evaluation/{mechanism}/datasets/{dataset_id}/runs` | `app.lab` | `start_mechanism_run` | oui | `back/app/lab/router.py:934` |
| DELETE | `/evaluation/{mechanism}/runs/{run_id}` | `app.lab` | `delete_mechanism_run` | oui | `back/app/lab/router.py:983` |
| GET | `/evaluation/{mechanism}/runs/{run_id}` | `app.lab` | `read_mechanism_run` | oui | `back/app/lab/router.py:971` |
| POST | `/evaluation/{mechanism}/runs/{run_id}/analyze` | `app.lab` | `analyze_mechanism_run` | oui | `back/app/lab/router.py:997` |
| POST | `/evaluation/{mechanism}/runs/{run_id}/cancel` | `app.lab` | `cancel_mechanism_run` | oui | `back/app/lab/router.py:1015` |
| GET | `/evaluation/{mechanism}/runs/{run_id}/human-review` | `app.lab` | `read_human_review` | oui | `back/app/lab/router.py:87` |
| POST | `/evaluation/{mechanism}/runs/{run_id}/human-review` | `app.lab` | `submit_human_review` | oui | `back/app/lab/router.py:100` |
| POST | `/evaluation/{mechanism}/runs/{run_id}/rejudge` | `app.lab` | `rejudge_benchmark` | oui | `back/app/lab/router.py:126` |
| POST | `/evaluation/{mechanism}/runs/{run_id}/resume` | `app.lab` | `resume_benchmark` | oui | `back/app/lab/router.py:139` |
...
| GET | `/llm-providers` | `app.llm` | `list_providers` | oui | `back/app/llm/provider_router.py:252` |
| POST | `/llm-providers` | `app.llm` | `create_provider` | oui | `back/app/llm/provider_router.py:260` |
| GET | `/llm-providers/catalog` | `app.llm` | `get_provider_catalog` | oui | `back/app/llm/provider_router.py:274` |
| PUT | `/llm-providers/catalog/{catalog_code}` | `app.llm` | `configure_catalog_provider` | oui | `back/app/llm/provider_router.py:315` |
| GET | `/llm-providers/catalog/{catalog_code}/resources` | `app.llm` | `list_catalog_resources` | oui | `back/app/llm/provider_router.py:281` |
| POST | `/llm-providers/fetch-pricing` | `app.llm` | `fetch_pricing` | oui | `back/app/llm/provider_router.py:145` |
| GET | `/llm-providers/llms` | `app.llm` | `list_llms` | oui | `back/app/llm/provider_router.py:106` |
| POST | `/llm-providers/llms` | `app.llm` | `create_llm` | oui | `back/app/llm/provider_router.py:118` |
| DELETE | `/llm-providers/llms/{llm_id}` | `app.llm` | `delete_llm` | oui | `back/app/llm/provider_router.py:233` |
| GET | `/llm-providers/llms/{llm_id}` | `app.llm` | `get_llm` | oui | `back/app/llm/provider_router.py:185` |
| PUT | `/llm-providers/llms/{llm_id}` | `app.llm` | `update_llm` | oui | `back/app/llm/provider_router.py:200` |
| POST | `/llm-providers/test` | `app.llm` | `test_provider_connection` | oui | `back/app/llm/provider_router.py:332` |
| DELETE | `/llm-providers/{provider_id}` | `app.llm` | `delete_provider` | oui | `back/app/llm/provider_router.py:511` |
| GET | `/llm-providers/{provider_id}` | `app.llm` | `get_provider` | oui | `back/app/llm/provider_router.py:468` |
| PUT | `/llm-providers/{provider_id}` | `app.llm` | `update_provider` | oui | `back/app/llm/provider_router.py:487` |
| GET | `/llm-providers/{provider_id}/models` | `app.llm` | `list_provider_models` | oui | `back/app/llm/provider_router.py:526` |
| POST | `/llm-providers/{provider_id}/models/delete` | `app.llm` | `delete_model` | oui | `back/app/llm/provider_router.py:700` |
| POST | `/llm-providers/{provider_id}/models/pull` | `app.llm` | `pull_model` | oui | `back/app/llm/provider_router.py:661` |
| DELETE | `/llm-providers/{provider_id}/oauth` | `app.llm` | `disconnect_provider_authentication` | oui | `back/app/llm/provider_router.py:449` |
| POST | `/llm-providers/{provider_id}/oauth/device` | `app.llm` | `start_provider_device_login` | oui | `back/app/llm/provider_router.py:387` |
| POST | `/llm-providers/{provider_id}/oauth/device/poll` | `app.llm` | `poll_provider_device_login` | oui | `back/app/llm/provider_router.py:417` |
| GET | `/llm-providers/{provider_id}/resources` | `app.llm` | `list_provider_resources` | oui | `back/app/llm/provider_router.py:578` |
| GET | `/llm-providers/{provider_id}/transcription-models` | `app.llm` | `list_provider_transcription_models` | oui | `back/app/llm/provider_router.py:624` |
