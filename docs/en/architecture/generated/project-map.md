...
|---|---|---:|---:|---|
| `core.user` | core | no | yes | `i18n/`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `core.team` | core | no | yes | `contracts.py`, `models.py`, `privileges.py`, `router.py`, `tests/` |
| `core.authorize` | core | no | yes | `i18n/`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `core.params` | core | no | yes | `i18n/`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `core.dbadmin` | core | no | yes | `contracts.py`, `models.py`, `tests/` |
| `app.incident` | app | no | yes | `contracts.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.tools` | app | no | yes | `contracts.py`, `facade.py`, `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.agent` | app | no | yes | `contracts.py`, `facade.py`, `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.harness` | app | no | yes | `contracts.py`, `facade.py`, `router.py`, `schemas.py`, `tests/` |
| `app.harnesses` | app | no | yes | `contracts.py`, `facade.py`, `models.py`, `router.py`, `schemas.py`, `tests/` |
| `app.connection` | app | no | yes | `facade.py`, `i18n/`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.skill` | app | no | yes | `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.webhook` | app | no | yes | `i18n/`, `router.py`, `schemas.py`, `tests/` |
| `app.llm` | app | no | yes | `contracts.py`, `facade.py`, `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.topic` | app | no | yes | `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.memory` | app | no | yes | `contracts.py`, `facade.py`, `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.contact` | app | no | yes | `contracts.py`, `facade.py`, `router.py`, `schemas.py`, `tests/` |
| `app.dream` | app | no | yes | `contracts.py`, `i18n/`, `interface.py`, `models.py`, `router.py`, `schemas.py`, `tests/` |
| `app.task` | app | no | yes | `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.goal` | app | no | yes | `facade.py`, `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.dashboard` | app | no | yes | `router.py`, `schemas.py`, `tests/` |
| `app.lab` | app | no | yes | `contracts.py`, `i18n/`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.messenger` | app | no | yes | `contracts.py`, `facade.py`, `i18n/`, `interface.py`, `mcp.py`, `models.py`, `router.py`, `schemas.py`, `tests/` |
| `app.chat` | app | no | yes | `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.conversation` | app | no | yes | `contracts.py`, `facade.py`, `i18n/`, `mcp.py`, `models.py`, `router.py`, `schemas.py`, `tests/` |
| `app.browser` | app | no | yes | `i18n/`, `mcp.py`, `router.py`, `schemas.py`, `tests/` |
| `app.image` | app | no | yes | `i18n/`, `mcp.py`, `router.py`, `schemas.py`, `tests/` |
| `app.audio` | app | no | yes | `i18n/`, `mcp.py`, `tests/` |
| `app.onboarding` | app | no | yes | `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.voice` | app | no | yes | `facade.py`, `i18n/`, `interface.py`, `mcp.py`, `models.py`, `router.py`, `schemas.py`, `tests/` |
| `app.file_share` | app | no | yes | `i18n/`, `interface.py`, `mcp.py`, `router.py`, `tests/` |
| `app.console` | app | no | yes | `contracts.py`, `i18n/`, `mcp.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.process` | app | no | yes | `i18n/`, `interface.py`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `app.multimedia` | app | no | yes | `mcp.py`, `models.py`, `router.py`, `tests/` |
| `app.mcp` | app | no | yes | `i18n/`, `models.py`, `privileges.py`, `router.py`, `schemas.py` |
| `bridge.harness` | bridge | no | yes | `i18n/`, `router.py`, `tests/` |
| `bridge.claude_agent` | bridge | no | yes | `tests/` |
| `bridge.codex` | bridge | no | yes | `router.py`, `tests/` |
| `bridge.deepseek_harness` | bridge | no | yes | `tests/` |
| `bridge.n8n` | bridge | no | yes | `router.py`, `schemas.py`, `tests/` |
| `bridge.mail` | bridge | no | yes | `contracts.py`, `mcp.py`, `models.py`, `router.py`, `schemas.py`, `tests/` |
| `bridge.calendar` | bridge | no | yes | `mcp.py`, `models.py`, `router.py`, `schemas.py`, `tests/` |
| `bridge.hermes` | bridge | no | yes | `i18n/`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
| `bridge.one_bot` | bridge | no | yes | `router.py`, `tests/` |
| `bridge.matrix` | bridge | no | yes | `router.py`, `schemas.py`, `tests/` |
| `bridge.nextcloud` | bridge | no | yes | `router.py`, `tests/` |
| `bridge.telegram` | bridge | no | yes | `router.py`, `schemas.py`, `tests/` |
| `bridge.whatsapp` | bridge | no | yes | `router.py`, `schemas.py`, `tests/` |
| `bridge.openrouter` | bridge | yes | yes | — |
| `bridge.mammouth` | bridge | yes | yes | — |
| `bridge.openai` | bridge | yes | yes | `i18n/`, `tests/` |
| `bridge.anthropic` | bridge | yes | yes | — |
| `bridge.deepseek` | bridge | yes | yes | — |
| `bridge.fireworks` | bridge | yes | yes | — |
| `bridge.groq` | bridge | yes | yes | — |
| `bridge.mistral` | bridge | yes | yes | — |
| `bridge.models_dev` | bridge | yes | yes | — |
| `bridge.together` | bridge | yes | yes | — |
| `bridge.cerebras` | bridge | yes | yes | — |
| `bridge.google` | bridge | yes | yes | — |
| `bridge.xai` | bridge | yes | yes | — |
| `bridge.nvidia` | bridge | yes | yes | — |
| `bridge.huggingface` | bridge | yes | yes | — |
| `bridge.cohere` | bridge | yes | yes | — |
| `bridge.perplexity` | bridge | yes | yes | — |
| `bridge.elevenlabs` | bridge | yes | yes | — |
| `bridge.sunoapi` | bridge | yes | yes | — |
| `bridge.byteplus` | bridge | yes | yes | — |
| `bridge.azure_speech` | bridge | yes | yes | — |
| `bridge.ollama` | bridge | yes | yes | — |

## Frontend Modules

| Module | Exists | Capabilities | Pages |
|---|---:|---|---:|
| `core/user` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 4 |
| `core/team` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services` | 1 |
| `core/authorize` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `presentation.ts`, `services`, `stores` | 2 |
| `core/params` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `presentation.ts`, `services`, `stores` | 3 |
| `app/index` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `presentation.ts`, `services`, `stores` | 6 |
| `app/agent` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/harnesses` | yes | `components`, `i18n.ts`, `pages`, `services` | 1 |
| `app/tools` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `presentation.ts`, `services`, `stores` | 1 |
| `app/browser` | yes | `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/connection` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/skill` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/llm` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `presentation.ts`, `services`, `stores` | 2 |
| `app/task` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/conversation` | yes | `components`, `i18n.ts`, `services` | 0 |
| `app/chat` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/voice` | yes | `components`, `i18n.ts`, `services` | 0 |
| `app/dream` | yes | `i18n.ts`, `navigation.ts`, `pages`, `services` | 1 |
| `app/topic` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services` | 2 |
| `app/goal` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/memory` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 3 |
| `app/lab` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `presentation.ts`, `services`, `stores` | 3 |
| `app/incident` | yes | `i18n.ts`, `navigation.ts`, `pages`, `services` | 1 |
| `app/process` | yes | `components`, `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `app/console` | yes | `i18n.ts`, `navigation.ts`, `pages`, `services`, `stores` | 1 |
| `bridge/nextcloud` | yes | `i18n.ts` | 0 |
| `bridge/matrix` | yes | `i18n.ts` | 0 |
| `bridge/telegram` | yes | `i18n.ts` | 0 |
| `bridge/whatsapp` | yes | `i18n.ts` | 0 |
| `bridge/one_bot` | yes | `i18n.ts` | 0 |
| `bridge/n8n` | yes | `components`, `i18n.ts`, `services` | 0 |
| `bridge/calendar` | yes | `i18n.ts` | 0 |
| `bridge/claude_agent` | yes | — | 0 |
| `bridge/codex` | yes | — | 0 |
| `bridge/deepseek_harness` | yes | — | 0 |
| `bridge/hermes` | yes | `components`, `i18n.ts`, `services` | 0 |
| `bridge/ollama` | yes | `i18n.ts` | 0 |
...
| GET | `/agents/{agent_id}/mcp-tokens` | `app.mcp` | `list_agent_mcp_tokens` | yes | `back/app/mcp/router.py:66` |
| POST | `/agents/{agent_id}/mcp-tokens` | `app.mcp` | `create_agent_mcp_token` | yes | `back/app/mcp/router.py:87` |
| DELETE | `/agents/{agent_id}/mcp-tokens/{token_id}` | `app.mcp` | `delete_agent_mcp_token` | yes | `back/app/mcp/router.py:137` |
| PUT | `/agents/{agent_id}/mcp-tokens/{token_id}` | `app.mcp` | `update_agent_mcp_token` | yes | `back/app/mcp/router.py:112` |
...
| GET | `/api/health/ready` | `core.api` | `readiness_check` | no | `back/core/api.py:277` |
| GET | `/api/openapi.json` | `core.api` | `get_public_openapi_endpoint` | no | `back/core/api.py:229` |
| GET | `/auth/avatars/{avatar_key}` | `core.user` | `read_user_avatar` | no | `back/core/user/router.py:409` |
| POST | `/auth/keep-alive` | `core.user` | `keep_alive` | yes | `back/core/user/router.py:382` |
| POST | `/auth/login` | `core.user` | `login` | no | `back/core/user/router.py:207` |
| POST | `/auth/login-json` | `core.user` | `login_json` | no | `back/core/user/router.py:231` |
| POST | `/auth/logout` | `core.user` | `logout` | no | `back/core/user/router.py:324` |
| DELETE | `/auth/me` | `core.user` | `delete_user_me` | yes | `back/core/user/router.py:475` |
| GET | `/auth/me` | `core.user` | `read_users_me` | yes | `back/core/user/router.py:401` |
| PUT | `/auth/me` | `core.user` | `update_user_me` | yes | `back/core/user/router.py:516` |
| DELETE | `/auth/me/avatar` | `core.user` | `delete_user_avatar` | yes | `back/core/user/router.py:463` |
| POST | `/auth/me/avatar` | `core.user` | `upload_user_avatar` | yes | `back/core/user/router.py:426` |
| GET | `/auth/me/help-dismissals` | `core.user` | `list_help_dismissals` | yes | `back/core/user/router.py:495` |
| PUT | `/auth/me/help-dismissals/{help_key}` | `core.user` | `dismiss_help` | yes | `back/core/user/router.py:505` |
| GET | `/auth/me/tokens` | `core.user` | `list_my_tokens` | yes | `back/core/user/router.py:610` |
| POST | `/auth/me/tokens` | `core.user` | `create_my_token` | yes | `back/core/user/router.py:623` |
| DELETE | `/auth/me/tokens/{token_id}` | `core.user` | `delete_my_token` | yes | `back/core/user/router.py:663` |
| PUT | `/auth/me/tokens/{token_id}` | `core.user` | `update_my_token` | yes | `back/core/user/router.py:644` |
| POST | `/auth/mfa/confirm` | `core.user` | `confirm_mfa` | yes | `back/core/user/router.py:285` |
| POST | `/auth/mfa/disable` | `core.user` | `disable_mfa` | yes | `back/core/user/router.py:298` |
| POST | `/auth/mfa/recovery-codes` | `core.user` | `regenerate_mfa_recovery_codes` | yes | `back/core/user/router.py:311` |
| POST | `/auth/mfa/setup` | `core.user` | `setup_mfa` | yes | `back/core/user/router.py:273` |
| GET | `/auth/mfa/status` | `core.user` | `read_mfa_status` | yes | `back/core/user/router.py:260` |
| POST | `/auth/refresh` | `core.user` | `refresh_session` | no | `back/core/user/router.py:342` |
| POST | `/auth/register` | `core.user` | `register` | no | `back/core/user/router.py:132` |
| GET | `/auth/registration-status` | `core.user` | `registration_status` | no | `back/core/user/router.py:120` |
| GET | `/auth/users` | `core.user` | `list_users` | yes | `back/core/user/router.py:546` |
| POST | `/auth/users` | `core.user` | `create_user_endpoint` | yes | `back/core/user/router.py:560` |
| DELETE | `/auth/users/{user_id}` | `core.user` | `delete_user_endpoint` | yes | `back/core/user/router.py:594` |
| GET | `/auth/users/{user_id}` | `core.user` | `read_user` | yes | `back/core/user/router.py:571` |
| PUT | `/auth/users/{user_id}` | `core.user` | `update_user_endpoint` | yes | `back/core/user/router.py:580` |
| GET | `/authorize/assignments` | `core.authorize` | `list_assignments` | yes | `back/core/authorize/router.py:269` |
| POST | `/authorize/assignments` | `core.authorize` | `create_assignment` | yes | `back/core/authorize/router.py:321` |
| DELETE | `/authorize/assignments/{id}` | `core.authorize` | `delete_assignment` | yes | `back/core/authorize/router.py:345` |
| PUT | `/authorize/assignments/{id}/default` | `core.authorize` | `set_default_assignment` | yes | `back/core/authorize/router.py:399` |
| GET | `/authorize/my-privileges` | `core.authorize` | `get_my_privileges` | yes | `back/core/authorize/router.py:66` |
| GET | `/authorize/privilege-lists` | `core.authorize` | `list_privilege_lists` | yes | `back/core/authorize/router.py:451` |
| POST | `/authorize/privilege-lists` | `core.authorize` | `create_privilege_list` | yes | `back/core/authorize/router.py:462` |
| DELETE | `/authorize/privilege-lists/{id}` | `core.authorize` | `delete_privilege_list` | yes | `back/core/authorize/router.py:508` |
| PUT | `/authorize/privilege-lists/{id}` | `core.authorize` | `update_privilege_list` | yes | `back/core/authorize/router.py:487` |
| DELETE | `/authorize/privilege-lists/{id}/privileges` | `core.authorize` | `remove_privileges_from_list` | yes | `back/core/authorize/router.py:560` |
| POST | `/authorize/privilege-lists/{id}/privileges` | `core.authorize` | `add_privileges_to_list` | yes | `back/core/authorize/router.py:529` |
| GET | `/authorize/privileges` | `core.authorize` | `list_privileges` | yes | `back/core/authorize/router.py:59` |
| POST | `/authorize/privileges` | `core.authorize` | `create_privilege` | yes | `back/core/authorize/router.py:89` |
| DELETE | `/authorize/privileges/{id}` | `core.authorize` | `delete_privilege` | yes | `back/core/authorize/router.py:107` |
| GET | `/authorize/roles` | `core.authorize` | `list_roles` | yes | `back/core/authorize/router.py:131` |
| POST | `/authorize/roles` | `core.authorize` | `create_role` | yes | `back/core/authorize/router.py:150` |
| DELETE | `/authorize/roles/{id}` | `core.authorize` | `delete_role` | yes | `back/core/authorize/router.py:191` |
| GET | `/authorize/roles/{id}` | `core.authorize` | `get_role` | yes | `back/core/authorize/router.py:138` |
| PUT | `/authorize/roles/{id}` | `core.authorize` | `update_role` | yes | `back/core/authorize/router.py:168` |
| DELETE | `/authorize/roles/{role_id}/privileges` | `core.authorize` | `remove_privileges_from_role` | yes | `back/core/authorize/router.py:242` |
| POST | `/authorize/roles/{role_id}/privileges` | `core.authorize` | `add_privileges_to_role` | yes | `back/core/authorize/router.py:211` |
| POST | `/authorize/switch-role` | `core.authorize` | `switch_role` | yes | `back/core/authorize/router.py:366` |
| GET | `/authorize/users/{user_id}/assignments` | `core.authorize` | `get_user_assignments` | yes | `back/core/authorize/router.py:307` |
| GET | `/browser/status` | `app.browser` | `status` | yes | `back/app/browser/router.py:18` |
| GET | `/calendars` | `bridge.calendar` | `read_calendars` | yes | `back/bridge/calendar/router.py:54` |
| POST | `/calendars` | `bridge.calendar` | `create_calendar` | yes | `back/bridge/calendar/router.py:61` |
...
| GET | `/chat/agents/{agent_id}/avatar` | `app.chat` | `read_agent_avatar` | yes | `back/app/chat/router.py:446` |
| GET | `/chat/emojis/frequent` | `app.chat` | `read_frequent_emojis` | yes | `back/app/chat/router.py:361` |
| POST | `/chat/emojis/usage` | `app.chat` | `create_emoji_usage` | yes | `back/app/chat/router.py:370` |
| POST | `/chat/html-previews` | `app.chat` | `create_standalone_html_preview` | yes | `back/app/chat/router.py:273` |
| GET | `/chat/html-previews/{ticket}` | `app.chat` | `read_standalone_html_preview` | no | `back/app/chat/router.py:288` |
| GET | `/chat/identities` | `app.chat` | `read_identity_mappings` | yes | `back/app/chat/router.py:380` |
| DELETE | `/chat/identities/{tool_id}` | `app.chat` | `delete_identity_mapping` | yes | `back/app/chat/router.py:410` |
| PUT | `/chat/identities/{tool_id}` | `app.chat` | `update_identity_mapping` | yes | `back/app/chat/router.py:389` |
| GET | `/chat/inbox` | `app.chat` | `read_inbox` | yes | `back/app/chat/router.py:322` |
| GET | `/chat/push/configuration` | `app.chat` | `read_push_configuration` | yes | `back/app/chat/router.py:328` |
| DELETE | `/chat/push/subscriptions` | `app.chat` | `remove_push_subscription` | yes | `back/app/chat/router.py:351` |
| POST | `/chat/push/subscriptions` | `app.chat` | `create_push_subscription` | yes | `back/app/chat/router.py:338` |
| GET | `/chat/recipients` | `app.chat` | `read_recipients` | yes | `back/app/chat/router.py:417` |
| GET | `/chat/rooms` | `app.chat` | `read_rooms` | yes | `back/app/chat/router.py:466` |
| POST | `/chat/rooms` | `app.chat` | `create_room` | yes | `back/app/chat/router.py:490` |
| GET | `/chat/rooms/{room_id}` | `app.chat` | `read_room` | yes | `back/app/chat/router.py:518` |
| PATCH | `/chat/rooms/{room_id}` | `app.chat` | `update_room_preferences` | yes | `back/app/chat/router.py:535` |
| GET | `/chat/rooms/{room_id}/activity` | `app.chat` | `read_activity` | yes | `back/app/chat/router.py:902` |
| GET | `/chat/rooms/{room_id}/activity/{round_id}` | `app.chat` | `read_activity_detail` | yes | `back/app/chat/router.py:917` |
| PATCH | `/chat/rooms/{room_id}/archive` | `app.chat` | `update_room_archive` | yes | `back/app/chat/router.py:553` |
| POST | `/chat/rooms/{room_id}/attachments` | `app.chat` | `create_attachment_message` | yes | `back/app/chat/router.py:1134` |
...
| GET | `/chat/rooms/{room_id}/commands` | `app.chat` | `read_room_commands` | yes | `back/app/chat/router.py:594` |
| POST | `/chat/rooms/{room_id}/dictation` | `app.chat` | `transcribe_dictation` | yes | `back/app/chat/router.py:1083` |
| GET | `/chat/rooms/{room_id}/documents` | `app.chat` | `read_room_documents` | yes | `back/app/chat/router.py:955` |
| POST | `/chat/rooms/{room_id}/documents` | `app.chat` | `create_room_document` | yes | `back/app/chat/router.py:985` |
| GET | `/chat/rooms/{room_id}/files/{file_id}` | `app.chat` | `download_file` | yes | `back/app/chat/router.py:1220` |
| GET | `/chat/rooms/{room_id}/interactions/{interaction_id}` | `app.chat` | `read_interaction` | yes | `back/app/chat/router.py:1031` |
| POST | `/chat/rooms/{room_id}/interactions/{interaction_id}/answer` | `app.chat` | `answer_interaction` | yes | `back/app/chat/router.py:1040` |
| GET | `/chat/rooms/{room_id}/messages` | `app.chat` | `read_messages` | yes | `back/app/chat/router.py:608` |
| POST | `/chat/rooms/{room_id}/messages` | `app.chat` | `create_message` | yes | `back/app/chat/router.py:1056` |
| GET | `/chat/rooms/{room_id}/messages/{message_id}/previews` | `app.chat` | `read_message_previews` | yes | `back/app/chat/router.py:758` |
| GET | `/chat/rooms/{room_id}/messages/{message_id}/previews/content` | `app.chat` | `read_message_preview_content` | yes | `back/app/chat/router.py:862` |
| GET | `/chat/rooms/{room_id}/messages/{message_id}/previews/image` | `app.chat` | `read_message_preview_image` | yes | `back/app/chat/router.py:809` |
| POST | `/chat/rooms/{room_id}/messages/{message_id}/speech` | `app.chat` | `read_message_speech` | yes | `back/app/chat/router.py:659` |
| PATCH | `/chat/rooms/{room_id}/messages/{message_id}/topic` | `app.chat` | `update_message_topic` | yes | `back/app/chat/router.py:727` |
| POST | `/chat/rooms/{room_id}/mute` | `app.chat` | `set_muted` | yes | `back/app/chat/router.py:1212` |
| GET | `/chat/rooms/{room_id}/processes` | `app.chat` | `read_room_processes` | yes | `back/app/chat/router.py:1013` |
| POST | `/chat/rooms/{room_id}/read` | `app.chat` | `mark_read` | yes | `back/app/chat/router.py:1204` |
| GET | `/chat/rooms/{room_id}/speech/status` | `app.chat` | `read_message_speech_status` | yes | `back/app/chat/router.py:633` |
| GET | `/chat/rooms/{room_id}/tasks` | `app.chat` | `read_room_tasks` | yes | `back/app/chat/router.py:934` |
| PATCH | `/chat/rooms/{room_id}/topic` | `app.chat` | `update_room_topic` | yes | `back/app/chat/router.py:570` |
| GET | `/chat/status` | `app.chat` | `read_status` | yes | `back/app/chat/router.py:312` |
| GET | `/chat/viewer-agents` | `app.chat` | `read_viewer_agents` | yes | `back/app/chat/router.py:439` |
...
| POST | `/connections/test-mcp-tools` | `app.connection` | `test_mcp_tools` | yes | `back/app/connection/router.py:450` |
| DELETE | `/connections/{connection_id}` | `app.connection` | `delete_connection` | yes | `back/app/connection/router.py:289` |
...
| GET | `/connections/{connection_id}/functions` | `app.connection` | `list_connection_functions` | yes | `back/app/connection/router.py:510` |
| PUT | `/connections/{connection_id}/functions/{function_name}` | `app.connection` | `set_connection_function` | yes | `back/app/connection/router.py:519` |
| PUT | `/connections/{connection_id}/functions/{function_name}/global` | `app.connection` | `set_connection_function_global` | yes | `back/app/connection/router.py:530` |
| GET | `/connections/{connection_id}/params` | `app.connection` | `get_connection_params` | yes | `back/app/connection/router.py:305` |
| POST | `/connections/{connection_id}/params` | `app.connection` | `create_or_update_param` | yes | `back/app/connection/router.py:352` |
| POST | `/connections/{connection_id}/params/bulk` | `app.connection` | `create_or_update_params_bulk` | yes | `back/app/connection/router.py:377` |
| DELETE | `/connections/{connection_id}/params/{param_name}` | `app.connection` | `delete_param` | yes | `back/app/connection/router.py:434` |
| GET | `/connections/{connection_id}/params/{param_name}` | `app.connection` | `get_single_param` | yes | `back/app/connection/router.py:325` |
| PATCH | `/connections/{connection_id}/params/{param_name}` | `app.connection` | `update_connection_param` | yes | `back/app/connection/router.py:402` |
...
| POST | `/console/embedded/provision` | `app.console` | `provision_embedded` | yes | `back/app/console/router.py:131` |
| POST | `/console/executor/action` | `app.console` | `executor_action` | yes | `back/app/console/router.py:177` |
| GET | `/console/executor/availability` | `app.console` | `executor_availability` | yes | `back/app/console/router.py:160` |
| GET | `/console/executor/status` | `app.console` | `executor_status` | yes | `back/app/console/router.py:166` |
| POST | `/console/host-key/scan` | `app.console` | `scan_host_key` | yes | `back/app/console/router.py:65` |
| GET | `/contacts` | `app.contact` | `read_contacts` | yes | `back/app/contact/router.py:44` |
| DELETE | `/contacts/{contact_item_id}` | `app.contact` | `forget_contact` | yes | `back/app/contact/router.py:80` |
| POST | `/contacts/{source_contact_item_id}/merge` | `app.contact` | `merge_contacts` | yes | `back/app/contact/router.py:61` |
| GET | `/conversations/messages` | `app.conversation` | `read_conversation_messages` | yes | `back/app/conversation/router.py:30` |
| DELETE | `/conversations/rounds/{round_id}` | `app.conversation` | `delete_conversation_round` | yes | `back/app/conversation/router.py:139` |
| GET | `/conversations/rounds/{round_id}` | `app.conversation` | `read_conversation_round` | yes | `back/app/conversation/router.py:73` |
| GET | `/conversations/rounds/{round_id}/dataset` | `app.conversation` | `export_conversation_round` | yes | `back/app/conversation/router.py:101` |
| POST | `/conversations/rounds/{round_id}/delivery-resolution` | `app.conversation` | `resolve_conversation_delivery` | yes | `back/app/conversation/router.py:114` |
| PUT | `/conversations/rounds/{round_id}/topic` | `app.conversation` | `update_conversation_round_topic` | yes | `back/app/conversation/router.py:79` |
| GET | `/dashboard` | `app.dashboard` | `read_dashboard` | yes | `back/app/dashboard/router.py:17` |
| GET | `/definitions` | `app.process` | `read_definitions` | yes | `back/app/process/router.py:125` |
| POST | `/definitions` | `app.process` | `create_definition` | yes | `back/app/process/router.py:138` |
| POST | `/definitions/sync` | `app.process` | `sync_definitions` | yes | `back/app/process/router.py:149` |
| DELETE | `/definitions/{process_id}` | `app.process` | `delete_definition` | yes | `back/app/process/router.py:183` |
| GET | `/definitions/{process_id}` | `app.process` | `read_definition` | yes | `back/app/process/router.py:161` |
| PUT | `/definitions/{process_id}` | `app.process` | `update_definition` | yes | `back/app/process/router.py:167` |
| GET | `/dream/overview` | `app.dream` | `read_dream_overview` | yes | `back/app/dream/router.py:46` |
| GET | `/dream/receipts` | `app.dream` | `read_dream_receipts` | yes | `back/app/dream/router.py:53` |
...
| GET | `/goals/referrers/messenger` | `app.goal` | `search_messenger_referrers` | yes | `back/app/goal/router.py:104` |
| GET | `/goals/settings` | `app.goal` | `read_goal_settings` | yes | `back/app/goal/router.py:119` |
| PATCH | `/goals/settings` | `app.goal` | `update_goal_settings` | yes | `back/app/goal/router.py:125` |
| GET | `/goals/tree` | `app.goal` | `read_goal_tree` | yes | `back/app/goal/router.py:142` |
| DELETE | `/goals/{goal_id}` | `app.goal` | `delete_goal` | yes | `back/app/goal/router.py:261` |
| GET | `/goals/{goal_id}` | `app.goal` | `read_goal` | yes | `back/app/goal/router.py:149` |
| PUT | `/goals/{goal_id}` | `app.goal` | `update_goal` | yes | `back/app/goal/router.py:188` |
| POST | `/goals/{goal_id}/complete` | `app.goal` | `complete_goal` | yes | `back/app/goal/router.py:235` |
| GET | `/goals/{goal_id}/cycles` | `app.goal` | `read_goal_cycles` | yes | `back/app/goal/router.py:156` |
| POST | `/goals/{goal_id}/pause` | `app.goal` | `pause_goal` | yes | `back/app/goal/router.py:209` |
| POST | `/goals/{goal_id}/resume` | `app.goal` | `resume_goal` | yes | `back/app/goal/router.py:222` |
| POST | `/goals/{goal_id}/run-now` | `app.goal` | `run_goal_now` | yes | `back/app/goal/router.py:248` |
| GET | `/harness-manager/configuration` | `bridge.harness` | `read_configuration` | yes | `back/bridge/harness/router.py:27` |
| PUT | `/harness-manager/configuration` | `bridge.harness` | `update_configuration` | yes | `back/bridge/harness/router.py:33` |
| GET | `/harness-manager/diagnostics` | `bridge.harness` | `manager_diagnostics` | yes | `back/bridge/harness/router.py:21` |
| POST | `/harness-manager/environment` | `bridge.harness` | `manager_environment` | yes | `back/bridge/harness/router.py:46` |
| POST | `/harness-manager/generate-secret` | `bridge.harness` | `generate_secret` | yes | `back/bridge/harness/router.py:39` |
| POST | `/harness-manager/installation.zip` | `bridge.harness` | `installation_archive` | yes | `back/bridge/harness/router.py:84` |
| GET | `/harness-manager/release` | `bridge.harness` | `release_manifest` | yes | `back/bridge/harness/router.py:72` |
| GET | `/harness-manager/release.zip` | `bridge.harness` | `release_archive` | yes | `back/bridge/harness/router.py:78` |
| GET | `/harness-manager/updates/archive/{digest}.zip` | `bridge.harness` | `update_archive` | no | `back/bridge/harness/router.py:113` |
| GET | `/harness-manager/updates/manifest` | `bridge.harness` | `update_manifest` | no | `back/bridge/harness/router.py:105` |
| DELETE | `/harnesses/agents/{id}` | `app.harnesses` | `select_internal_harness` | yes | `back/app/harnesses/router.py:234` |
| GET | `/harnesses/agents/{id}` | `app.harnesses` | `read_agent_harness` | yes | `back/app/harnesses/router.py:201` |
| PUT | `/harnesses/agents/{id}` | `app.harnesses` | `install_agent_harness` | yes | `back/app/harnesses/router.py:214` |
| POST | `/harnesses/agents/{id}/actions/{action}` | `app.harness` | `run_harness_action` | yes | `back/app/harness/router.py:60` |
| POST | `/harnesses/agents/{id}/actions/{action}` | `app.harnesses` | `run_harness_action` | yes | `back/app/harnesses/router.py:332` |
| GET | `/harnesses/agents/{id}/logs` | `app.harness` | `harness_logs` | yes | `back/app/harness/router.py:74` |
| GET | `/harnesses/agents/{id}/logs` | `app.harnesses` | `harness_logs` | yes | `back/app/harnesses/router.py:361` |
| POST | `/harnesses/agents/{id}/refresh` | `app.harness` | `refresh_harness` | yes | `back/app/harness/router.py:84` |
| GET | `/harnesses/agents/{id}/status` | `app.harness` | `harness_status` | yes | `back/app/harness/router.py:46` |
| GET | `/harnesses/agents/{id}/status` | `app.harnesses` | `harness_status` | yes | `back/app/harnesses/router.py:283` |
| GET | `/harnesses/agents/{id}/task-blockers` | `app.harnesses` | `harness_task_blockers` | yes | `back/app/harnesses/router.py:252` |
| POST | `/harnesses/agents/{id}/task-blockers/terminate-paused` | `app.harnesses` | `terminate_harness_paused_tasks` | yes | `back/app/harnesses/router.py:261` |
| GET | `/harnesses/catalog` | `app.harnesses` | `list_harness_catalogue` | yes | `back/app/harnesses/router.py:120` |
| POST | `/harnesses/catalog` | `app.harnesses` | `create_harness` | yes | `back/app/harnesses/router.py:132` |
| POST | `/harnesses/catalog/probe` | `app.harnesses` | `probe_harness` | yes | `back/app/harnesses/router.py:141` |
| DELETE | `/harnesses/catalog/{harness_id}` | `app.harnesses` | `delete_harness` | yes | `back/app/harnesses/router.py:182` |
| GET | `/harnesses/catalog/{harness_id}` | `app.harnesses` | `read_harness` | yes | `back/app/harnesses/router.py:150` |
| PUT | `/harnesses/catalog/{harness_id}` | `app.harnesses` | `update_harness` | yes | `back/app/harnesses/router.py:163` |
...
| GET | `/hermes/reachable` | `bridge.hermes` | `hermes_reachable` | yes | `back/bridge/hermes/router.py:104` |
| GET | `/incidents` | `app.incident` | `read_incidents` | yes | `back/app/incident/router.py:77` |
| DELETE | `/incidents/cleanup` | `app.incident` | `cleanup_incidents` | yes | `back/app/incident/router.py:143` |
| GET | `/incidents/patterns` | `app.incident` | `read_patterns` | yes | `back/app/incident/router.py:103` |
| PATCH | `/incidents/patterns/{pattern_id}` | `app.incident` | `patch_pattern` | yes | `back/app/incident/router.py:171` |
| GET | `/incidents/recent` | `app.incident` | `read_recent_incidents` | yes | `back/app/incident/router.py:127` |
| GET | `/incidents/{incident_id}` | `app.incident` | `read_incident` | yes | `back/app/incident/router.py:152` |
| POST | `/janus/openai/chat/completions` | `app.agent` | `janus_chat_completions` | yes | `back/app/agent/openai_router.py:179` |
| GET | `/janus/openai/models` | `app.agent` | `get_janus_models` | yes | `back/app/agent/openai_router.py:163` |
| GET | `/llm-calls` | `app.llm` | `read_calls` | yes | `back/app/llm/call_router.py:415` |
| DELETE | `/llm-calls/cleanup` | `app.llm` | `cleanup_calls` | yes | `back/app/llm/call_router.py:485` |
| GET | `/llm-calls/history` | `app.llm` | `read_call_history` | yes | `back/app/llm/call_router.py:458` |
| GET | `/llm-calls/retention/preview` | `app.llm` | `preview_call_retention` | yes | `back/app/llm/call_router.py:494` |
| GET | `/llm-calls/running` | `app.llm` | `read_running_calls` | yes | `back/app/llm/call_router.py:440` |
| DELETE | `/llm-calls/{call_id}` | `app.llm` | `delete_call` | yes | `back/app/llm/call_router.py:503` |
| GET | `/llm-calls/{call_id}` | `app.llm` | `read_call` | yes | `back/app/llm/call_router.py:522` |
...
| GET | `/llm-providers` | `app.llm` | `list_providers` | yes | `back/app/llm/provider_router.py:252` |
| POST | `/llm-providers` | `app.llm` | `create_provider` | yes | `back/app/llm/provider_router.py:260` |
| GET | `/llm-providers/catalog` | `app.llm` | `get_provider_catalog` | yes | `back/app/llm/provider_router.py:274` |
| PUT | `/llm-providers/catalog/{catalog_code}` | `app.llm` | `configure_catalog_provider` | yes | `back/app/llm/provider_router.py:315` |
| GET | `/llm-providers/catalog/{catalog_code}/resources` | `app.llm` | `list_catalog_resources` | yes | `back/app/llm/provider_router.py:281` |
| POST | `/llm-providers/fetch-pricing` | `app.llm` | `fetch_pricing` | yes | `back/app/llm/provider_router.py:145` |
| GET | `/llm-providers/llms` | `app.llm` | `list_llms` | yes | `back/app/llm/provider_router.py:106` |
| POST | `/llm-providers/llms` | `app.llm` | `create_llm` | yes | `back/app/llm/provider_router.py:118` |
| DELETE | `/llm-providers/llms/{llm_id}` | `app.llm` | `delete_llm` | yes | `back/app/llm/provider_router.py:233` |
| GET | `/llm-providers/llms/{llm_id}` | `app.llm` | `get_llm` | yes | `back/app/llm/provider_router.py:185` |
| PUT | `/llm-providers/llms/{llm_id}` | `app.llm` | `update_llm` | yes | `back/app/llm/provider_router.py:200` |
| POST | `/llm-providers/test` | `app.llm` | `test_provider_connection` | yes | `back/app/llm/provider_router.py:332` |
| DELETE | `/llm-providers/{provider_id}` | `app.llm` | `delete_provider` | yes | `back/app/llm/provider_router.py:511` |
| GET | `/llm-providers/{provider_id}` | `app.llm` | `get_provider` | yes | `back/app/llm/provider_router.py:468` |
| PUT | `/llm-providers/{provider_id}` | `app.llm` | `update_provider` | yes | `back/app/llm/provider_router.py:487` |
| GET | `/llm-providers/{provider_id}/models` | `app.llm` | `list_provider_models` | yes | `back/app/llm/provider_router.py:526` |
| POST | `/llm-providers/{provider_id}/models/delete` | `app.llm` | `delete_model` | yes | `back/app/llm/provider_router.py:700` |
| POST | `/llm-providers/{provider_id}/models/pull` | `app.llm` | `pull_model` | yes | `back/app/llm/provider_router.py:661` |
| DELETE | `/llm-providers/{provider_id}/oauth` | `app.llm` | `disconnect_provider_authentication` | yes | `back/app/llm/provider_router.py:449` |
| POST | `/llm-providers/{provider_id}/oauth/device` | `app.llm` | `start_provider_device_login` | yes | `back/app/llm/provider_router.py:387` |
| POST | `/llm-providers/{provider_id}/oauth/device/poll` | `app.llm` | `poll_provider_device_login` | yes | `back/app/llm/provider_router.py:417` |
| GET | `/llm-providers/{provider_id}/resources` | `app.llm` | `list_provider_resources` | yes | `back/app/llm/provider_router.py:578` |
| GET | `/llm-providers/{provider_id}/transcription-models` | `app.llm` | `list_provider_transcription_models` | yes | `back/app/llm/provider_router.py:624` |
...
| GET | `/llm/me/options` | `app.llm` | `get_options` | yes | `back/app/llm/personal_router.py:56` |
| GET | `/llm/me/preferences` | `app.llm` | `get_preferences` | yes | `back/app/llm/personal_router.py:41` |
| PUT | `/llm/me/preferences` | `app.llm` | `put_preferences` | yes | `back/app/llm/personal_router.py:47` |
| POST | `/llm/me/speech` | `app.llm` | `speech` | yes | `back/app/llm/personal_router.py:122` |
| POST | `/llm/me/transcription` | `app.llm` | `transcribe` | yes | `back/app/llm/personal_router.py:85` |
| POST | `/llm/openai/chat/completions` | `app.llm` | `llm_completion` | no | `back/app/llm/call_router.py:189` |
| POST | `/llm/openai/inferences` | `app.llm` | `create_inference` | no | `back/app/llm/call_router.py:106` |
| GET | `/llm/openai/inferences/{inference_id}` | `app.llm` | `get_inference` | no | `back/app/llm/call_router.py:130` |
| POST | `/llm/openai/inferences/{inference_id}/commands` | `app.llm` | `command_inference` | no | `back/app/llm/call_router.py:136` |
| GET | `/llm/openai/inferences/{inference_id}/events` | `app.llm` | `inference_events` | no | `back/app/llm/call_router.py:150` |
| GET | `/llm/openai/models` | `app.llm` | `llm_models` | no | `back/app/llm/call_router.py:172` |
| POST | `/llm/openai/responses` | `app.llm` | `llm_responses` | no | `back/app/llm/call_router.py:306` |
| POST | `/llm/openai/responses/compact` | `app.llm` | `llm_responses` | no | `back/app/llm/call_router.py:306` |
| GET | `/llm/openai/runs/{agent_run_id}/usage` | `app.llm` | `llm_run_usage` | no | `back/app/llm/call_router.py:397` |
| GET | `/llm/users/{user_id}/preferences` | `app.llm` | `get_user_preferences` | yes | `back/app/llm/personal_router.py:68` |
| PUT | `/llm/users/{user_id}/preferences` | `app.llm` | `put_user_preferences` | yes | `back/app/llm/personal_router.py:75` |
| GET | `/mail/approvers` | `bridge.mail` | `list_mail_approvers` | yes | `back/bridge/mail/router.py:100` |
| POST | `/mail/connections/{connection_id}/test` | `bridge.mail` | `test_connection` | yes | `back/bridge/mail/router.py:167` |
| GET | `/mail/outbound` | `bridge.mail` | `list_outbound_mail` | yes | `back/bridge/mail/router.py:64` |
| GET | `/mail/outbound/agents` | `bridge.mail` | `list_outbound_mail_agents` | yes | `back/bridge/mail/router.py:87` |
| GET | `/mail/outbound/{delivery_id}` | `bridge.mail` | `read_outbound_mail` | yes | `back/bridge/mail/router.py:106` |
...
| GET | `/memory/documents/folders` | `app.memory` | `read_document_folders` | yes | `back/app/memory/router.py:790` |
| POST | `/memory/documents/icons/resolve` | `app.memory` | `resolve_document_icons` | yes | `back/app/memory/router.py:673` |
| GET | `/memory/documents/keywords` | `app.memory` | `read_document_keywords` | yes | `back/app/memory/router.py:637` |
| POST | `/memory/documents/library` | `app.memory` | `browse_managed_documents` | yes | `back/app/memory/router.py:656` |
| PUT | `/memory/documents/order` | `app.memory` | `reorder_personal_documents` | yes | `back/app/memory/router.py:692` |
| PUT | `/memory/documents/order/sort` | `app.memory` | `sort_personal_documents` | yes | `back/app/memory/router.py:703` |
| GET | `/memory/documents/owner-options` | `app.memory` | `read_document_owner_options` | yes | `back/app/memory/router.py:806` |
| GET | `/memory/documents/tag-icons` | `app.memory` | `read_personal_tag_icons` | yes | `back/app/memory/router.py:714` |
| POST | `/memory/documents/tag-icons` | `app.memory` | `upload_personal_tag_icon` | yes | `back/app/memory/router.py:720` |
| GET | `/memory/documents/tags` | `app.memory` | `read_personal_document_tags` | yes | `back/app/memory/router.py:738` |
...
| GET | `/messenger/bridges` | `app.messenger` | `list_messenger_bridges` | yes | `back/app/messenger/router.py:20` |
| GET | `/messenger/channels` | `app.messenger` | `list_enabled_messenger_channels` | yes | `back/app/messenger/router.py:68` |
| POST | `/messenger/configuration/test` | `app.messenger` | `test_messenger_configuration` | yes | `back/app/messenger/router.py:31` |
| GET | `/messenger/users` | `app.messenger` | `search_messenger_users` | yes | `back/app/messenger/router.py:41` |
| GET | `/metrics` | `app.process` | `read_metrics` | yes | `back/app/process/router.py:431` |
| POST | `/multimedia/callback/{run_id}/{token}` | `app.multimedia` | `acknowledge_callback` | no | `back/app/multimedia/router.py:54` |
| GET | `/multimedia/runs/{run_id}/deliveries` | `app.multimedia` | `list_deliveries` | yes | `back/app/multimedia/router.py:29` |
...
| GET | `/retention/preview` | `app.process` | `preview_retention` | yes | `back/app/process/router.py:79` |
| GET | `/runs` | `app.process` | `read_runs` | yes | `back/app/process/router.py:237` |
| POST | `/runs` | `app.process` | `create_run` | yes | `back/app/process/router.py:191` |
| DELETE | `/runs/{run_id}` | `app.process` | `delete_run` | yes | `back/app/process/router.py:293` |
| GET | `/runs/{run_id}` | `app.process` | `read_run` | yes | `back/app/process/router.py:283` |
| POST | `/runs/{run_id}/analyze` | `app.process` | `analyze_run` | yes | `back/app/process/router.py:318` |
| POST | `/runs/{run_id}/cancel` | `app.process` | `cancel_run` | yes | `back/app/process/router.py:328` |
| POST | `/runs/{run_id}/events` | `app.process` | `receive_event` | no | `back/app/process/router.py:361` |
| GET | `/runs/{run_id}/export` | `app.process` | `export_process_run` | yes | `back/app/process/router.py:86` |
| GET | `/runs/{run_id}/files/{file_id}` | `app.process` | `download_run_file` | no | `back/app/process/router.py:375` |
...
| GET | `/skills/authorizations` | `app.skill` | `list_skill_authorizations` | yes | `back/app/skill/router.py:132` |
| GET | `/skills/categories` | `app.skill` | `list_skill_categories` | yes | `back/app/skill/router.py:156` |
| POST | `/skills/categories` | `app.skill` | `create_skill_category` | yes | `back/app/skill/router.py:169` |
| DELETE | `/skills/categories/{category_id}` | `app.skill` | `delete_skill_category` | yes | `back/app/skill/router.py:199` |
| PUT | `/skills/categories/{category_id}` | `app.skill` | `update_skill_category` | yes | `back/app/skill/router.py:180` |
| PUT | `/skills/categories/{category_id}/authorization/agents/{agent_id}` | `app.skill` | `update_category_authorization` | yes | `back/app/skill/router.py:216` |
| POST | `/skills/import` | `app.skill` | `import_skill` | yes | `back/app/skill/router.py:98` |
| GET | `/skills/learned` | `app.skill` | `list_learned_skills` | yes | `back/app/skill/router.py:278` |
| GET | `/skills/learned/status` | `app.skill` | `get_learned_skill_status` | yes | `back/app/skill/router.py:302` |
| GET | `/skills/learned/{learned_skill_id}` | `app.skill` | `get_learned_skill` | yes | `back/app/skill/router.py:309` |
| PUT | `/skills/learned/{learned_skill_id}/suspension` | `app.skill` | `suspend_learned_skill` | yes | `back/app/skill/router.py:327` |
| POST | `/skills/rescan` | `app.skill` | `rescan_skills` | yes | `back/app/skill/router.py:86` |
| DELETE | `/skills/{skill_id}` | `app.skill` | `delete_skill` | yes | `back/app/skill/router.py:379` |
| GET | `/skills/{skill_id}` | `app.skill` | `get_skill` | yes | `back/app/skill/router.py:357` |
| PUT | `/skills/{skill_id}` | `app.skill` | `update_skill` | yes | `back/app/skill/router.py:363` |
| PUT | `/skills/{skill_id}/authorization/agents/{agent_id}` | `app.skill` | `update_agent_authorization` | yes | `back/app/skill/router.py:440` |
| PUT | `/skills/{skill_id}/authorization/global` | `app.skill` | `update_global_authorization` | yes | `back/app/skill/router.py:415` |
| PUT | `/skills/{skill_id}/category` | `app.skill` | `assign_skill_category` | yes | `back/app/skill/router.py:392` |
| GET | `/skills/{skill_id}/content` | `app.skill` | `read_skill_file` | yes | `back/app/skill/router.py:494` |
| GET | `/skills/{skill_id}/download` | `app.skill` | `download_skill` | yes | `back/app/skill/router.py:468` |
| GET | `/skills/{skill_id}/file` | `app.skill` | `download_skill_file` | yes | `back/app/skill/router.py:506` |
| GET | `/skills/{skill_id}/files` | `app.skill` | `list_skill_files` | yes | `back/app/skill/router.py:484` |
| GET | `/tasks` | `app.task` | `read_tasks` | yes | `back/app/task/router.py:58` |
| POST | `/tasks` | `app.task` | `create_task` | yes | `back/app/task/router.py:175` |
| GET | `/tasks/active` | `app.task` | `read_active_tasks` | yes | `back/app/task/router.py:137` |
| POST | `/tasks/activity` | `app.task` | `read_task_activity` | yes | `back/app/task/router.py:148` |
| DELETE | `/tasks/cleanup` | `app.task` | `cleanup_tasks` | yes | `back/app/task/router.py:285` |
| GET | `/tasks/recent` | `app.task` | `read_recent_tasks` | yes | `back/app/task/router.py:78` |
| DELETE | `/tasks/{task_id}` | `app.task` | `delete_task` | yes | `back/app/task/router.py:295` |
| GET | `/tasks/{task_id}` | `app.task` | `read_task` | yes | `back/app/task/router.py:155` |
| PUT | `/tasks/{task_id}` | `app.task` | `update_task` | yes | `back/app/task/router.py:199` |
| GET | `/tasks/{task_id}/budget` | `app.task` | `read_task_budget` | yes | `back/app/task/router.py:165` |
| POST | `/tasks/{task_id}/cancel` | `app.task` | `cancel_task` | yes | `back/app/task/router.py:253` |
| GET | `/tasks/{task_id}/children` | `app.task` | `read_task_children` | yes | `back/app/task/router.py:369` |
| POST | `/tasks/{task_id}/force-terminate` | `app.task` | `force_terminate_task` | yes | `back/app/task/router.py:268` |
| GET | `/tasks/{task_id}/full` | `app.task` | `read_task_full` | yes | `back/app/task/router.py:359` |
| POST | `/tasks/{task_id}/pause` | `app.task` | `pause_task` | yes | `back/app/task/router.py:326` |
| POST | `/tasks/{task_id}/restore` | `app.task` | `restore_task` | yes | `back/app/task/router.py:312` |
| POST | `/tasks/{task_id}/resume` | `app.task` | `resume_task` | yes | `back/app/task/router.py:340` |
| POST | `/tasks/{task_id}/retry` | `app.task` | `retry_task` | yes | `back/app/task/router.py:219` |
| POST | `/tasks/{task_id}/run` | `app.task` | `run_task` | yes | `back/app/task/router.py:385` |
| GET | `/teams` | `core.team` | `list_teams` | yes | `back/core/team/router.py:13` |
| POST | `/teams` | `core.team` | `create_team` | yes | `back/core/team/router.py:25` |
| GET | `/teams/humans` | `core.team` | `search_humans` | yes | `back/core/team/router.py:19` |
| DELETE | `/teams/{team_id}` | `core.team` | `delete_team` | yes | `back/core/team/router.py:49` |
| PUT | `/teams/{team_id}` | `core.team` | `update_team` | yes | `back/core/team/router.py:36` |
| GET | `/teams/{team_id}/humans` | `core.team` | `team_humans` | yes | `back/core/team/router.py:70` |
...
| GET | `/tools` | `app.tools` | `list_tools` | yes | `back/app/tools/router.py:108` |
| POST | `/tools` | `app.tools` | `create_tool` | yes | `back/app/tools/router.py:199` |
| GET | `/tools/agents/{agent_id}/mcp-tools` | `app.tools` | `list_agent_mcp_tools` | yes | `back/app/tools/router.py:118` |
| POST | `/tools/import` | `app.tools` | `import_tool` | yes | `back/app/tools/router.py:289` |
| POST | `/tools/test-mcp` | `app.tools` | `test_mcp_connection` | yes | `back/app/tools/router.py:127` |
| GET | `/tools/{tool_code}/health` | `app.process` | `read_process_tool_health` | yes | `back/app/process/router.py:105` |
| DELETE | `/tools/{tool_id}` | `app.tools` | `delete_tool` | yes | `back/app/tools/router.py:251` |
| GET | `/tools/{tool_id}` | `app.tools` | `get_tool` | yes | `back/app/tools/router.py:147` |
| PUT | `/tools/{tool_id}` | `app.tools` | `update_tool` | yes | `back/app/tools/router.py:215` |
| PATCH | `/tools/{tool_id}/conversation-access` | `app.tools` | `update_conversation_access` | yes | `back/app/tools/router.py:231` |
| GET | `/tools/{tool_id}/export` | `app.tools` | `export_tool` | yes | `back/app/tools/router.py:266` |
| GET | `/tools/{tool_id}/global-params` | `app.tools` | `get_global_params` | yes | `back/app/tools/router.py:159` |
| PUT | `/tools/{tool_id}/global-params` | `app.tools` | `update_global_params` | yes | `back/app/tools/router.py:176` |
...
| GET | `/topics/keywords` | `app.topic` | `read_topic_keywords` | yes | `back/app/topic/router.py:72` |
| GET | `/topics/refs` | `app.topic` | `read_topic_refs` | yes | `back/app/topic/router.py:80` |
| DELETE | `/topics/{topic_id}` | `app.topic` | `delete_topic` | yes | `back/app/topic/router.py:177` |
| GET | `/topics/{topic_id}` | `app.topic` | `read_topic` | yes | `back/app/topic/router.py:185` |
| PUT | `/topics/{topic_id}` | `app.topic` | `update_topic` | yes | `back/app/topic/router.py:133` |
| GET | `/topics/{topic_id}/content` | `app.topic` | `read_topic_content` | yes | `back/app/topic/router.py:116` |
...
| GET | `/voice/conversations/turns/{turn_id}/dataset` | `app.voice` | `export_voice_conversation_turn` | yes | `back/app/voice/router.py:119` |
| PUT | `/voice/conversations/turns/{turn_id}/topic` | `app.voice` | `update_voice_conversation_turn_topic` | yes | `back/app/voice/router.py:97` |
| GET | `/voice/conversations/{conversation_id}` | `app.voice` | `read_voice_conversation` | yes | `back/app/voice/router.py:147` |
| GET | `/whatsapp/webhook` | `bridge.whatsapp` | `verify_webhook` | no | `back/bridge/whatsapp/router.py:81` |
| POST | `/whatsapp/webhook` | `bridge.whatsapp` | `receive_webhook` | no | `back/bridge/whatsapp/router.py:253` |
| GET | `/whatsapp/webhook/{tool_id}` | `bridge.whatsapp` | `verify_tool_webhook` | no | `back/bridge/whatsapp/router.py:100` |
| POST | `/whatsapp/webhook/{tool_id}` | `bridge.whatsapp` | `receive_tool_webhook` | no | `back/bridge/whatsapp/router.py:261` |
| POST | `/workflows/{workflow_id}/runs/{engine_run_id}/sync` | `app.process` | `sync_engine_run` | yes | `back/app/process/router.py:216` |
| WEBSOCKET | `/ws/onebot/{platform}/{user_id}` | `bridge.one_bot` | `onebot_endpoint` | no | `back/bridge/one_bot/router.py:134` |
...
| `chat_emoji_usages` | `ChatEmojiUsage` | `app.chat` | no | `users.id` | `back/app/chat/models.py:25` |
| `chat_push_deliveries` | `ChatPushDelivery` | `app.chat` | no | `chat_push_subscriptions.id`, `messenger_messages.id`, `messenger_rooms.id`, `users.id` | `back/app/chat/models.py:105` |
| `chat_push_subscriptions` | `ChatPushSubscription` | `app.chat` | no | `users.id` | `back/app/chat/models.py:62` |
| `connection_function_state` | `ConnectionFunctionState` | `app.connection` | no | `connections.id` | `back/app/connection/models.py:51` |
| `connection_params` | `ConnectionParam` | `app.connection` | no | `connections.id` | `back/app/connection/models.py:32` |
...
| `document_app_grants` | `DocumentAppGrant` | `app.memory` | yes | `memory_items.id`, `users.id` | `back/app/memory/models.py:95` |
| `document_app_write_budgets` | `DocumentAppWriteBudget` | `app.memory` | no | `memory_items.id`, `users.id` | `back/app/memory/models.py:113` |
| `document_attachments` | `DocumentAttachment` | `app.memory` | no | `memory_items.id` | `back/app/memory/models.py:138` |
| `document_icons` | `DocumentIcon` | `app.memory` | no | `memory_items.id`, `users.id` | `back/app/memory/models.py:83` |
| `document_list_positions` | `DocumentListPosition` | `app.memory` | no | `memory_items.id`, `users.id` | `back/app/memory/models.py:126` |
...
| `harness_execution_configurations` | `HarnessExecutionConfiguration` | `app.harnesses` | yes | — | `back/app/harnesses/models.py:18` |
| `harnesses` | `Harness` | `app.harnesses` | yes | — | `back/app/harnesses/models.py:29` |
| `hermes_agent_configs` | `HermesAgentConfig` | `bridge.hermes` | no | `agents.id` | `back/bridge/hermes/models.py:14` |
| `hermes_session_bindings` | `HermesSessionBinding` | `bridge.hermes` | no | `agents.id` | `back/bridge/hermes/models.py:73` |
| `lab_evaluation_cases` | `LabEvaluationCase` | `app.lab` | yes | `lab_evaluation_cases.id`, `lab_evaluation_datasets.id` | `back/app/lab/models.py:130` |
| `lab_evaluation_datasets` | `LabEvaluationDataset` | `app.lab` | yes | — | `back/app/lab/models.py:89` |
| `lab_evaluation_run_cases` | `LabEvaluationRunCase` | `app.lab` | yes | `lab_evaluation_cases.id`, `lab_evaluation_runs.id` | `back/app/lab/models.py:285` |
| `lab_evaluation_runs` | `LabEvaluationRun` | `app.lab` | yes | `lab_evaluation_datasets.id`, `llms.id` | `back/app/lab/models.py:191` |
| `lab_human_reviews` | `LabHumanReview` | `app.lab` | yes | `lab_evaluation_run_cases.id`, `lab_judgment_campaigns.id`, `users.id` | `back/app/lab/models.py:385` |
| `lab_judgment_campaigns` | `LabJudgmentCampaign` | `app.lab` | yes | `lab_evaluation_runs.id`, `llms.id` | `back/app/lab/models.py:333` |
| `lab_judgment_results` | `LabJudgmentResult` | `app.lab` | yes | `lab_evaluation_run_cases.id`, `lab_judgment_campaigns.id` | `back/app/lab/models.py:360` |
| `lab_task_diagnoses` | `LabTaskDiagnosis` | `app.lab` | yes | `tasks.id` | `back/app/lab/models.py:43` |
| `lab_tasks` | `LabTask` | `app.lab` | no | `tasks.id` | `back/app/lab/models.py:27` |
| `learned_skill_evidences` | `LearnedSkillEvidence` | `app.skill` | no | `learned_skills.id` | `back/app/skill/models.py:204` |
| `learned_skills` | `LearnedSkill` | `app.skill` | yes | `agents.id` | `back/app/skill/models.py:145` |
| `llm_call_events` | `LLMCallEvent` | `app.llm` | no | `llm_calls.id`, `llm_inferences.id` | `back/app/llm/models.py:58` |
| `llm_calls` | `LLMCall` | `app.llm` | no | `agents.id`, `conversation_rounds.id`, `llm_inference_attempts.id`, `llms.id`, `process_runs.id`, `task_attempts.id`, `tasks.id`, `users.id` | `back/app/llm/models.py:77` |
| `llm_inference_attempts` | `LLMInferenceAttempt` | `app.llm` | no | `llm_inferences.id` | `back/app/llm/models.py:30` |
| `llm_inference_commands` | `LLMInferenceCommand` | `app.llm` | no | `llm_inference_attempts.id`, `llm_inferences.id` | `back/app/llm/models.py:46` |
| `llm_inferences` | `LLMInference` | `app.llm` | no | `llm_inferences.id`, `users.id` | `back/app/llm/models.py:16` |
| `llm_profiles` | `LlmProfile` | `app.llm` | no | `llms.id` | `back/app/llm/profile_models.py:18` |
...
| `messenger_files` | `File` | `app.messenger` | yes | `connections.id` | `back/app/messenger/models.py:407` |
| `messenger_interactions` | `Interaction` | `app.messenger` | no | `connections.id` | `back/app/messenger/models.py:191` |
| `messenger_listener_state` | `ListenerState` | `app.messenger` | no | `connections.id` | `back/app/messenger/models.py:463` |
| `messenger_message_files` | `Attachment` | `app.messenger` | no | `messenger_files.id`, `messenger_messages.id` | `back/app/messenger/models.py:444` |
| `messenger_messages` | `Message` | `app.messenger` | yes | `connections.id`, `memory_items.id`, `messenger_rooms.id`, `messenger_users.id`, `topics.id`, `users.id` | `back/app/messenger/models.py:233` |
| `messenger_room_users` | `RoomUser` | `app.messenger` | no | `messenger_messages.id`, `messenger_rooms.id`, `messenger_users.id` | `back/app/messenger/models.py:138` |
| `messenger_rooms` | `Room` | `app.messenger` | yes | `connections.id`, `topics.id` | `back/app/messenger/models.py:62` |
| `messenger_users` | `MessengerUser` | `app.messenger` | yes | `agents.id`, `tools.id`, `users.id` | `back/app/messenger/models.py:95` |
| `multimedia_delivery_resolutions` | `MediaDeliveryResolution` | `app.multimedia` | no | `multimedia_output_receipts.id`, `users.id` | `back/app/multimedia/models.py:31` |
| `multimedia_output_receipts` | `MediaOutputReceipt` | `app.multimedia` | no | `process_runs.id` | `back/app/multimedia/models.py:13` |
| `params` | `Param` | `core.params` | no | — | `back/core/params/models.py:7` |
| `privilege_lists` | `PrivilegeList` | `core.authorize` | no | — | `back/core/authorize/models.py:41` |
| `privileges` | `Privilege` | `core.authorize` | no | `privilege_lists.id` | `back/core/authorize/models.py:22` |
| `process_definitions` | `ProcessDefinition` | `app.process` | yes | `agents.id`, `tools.id` | `back/app/process/models.py:25` |
| `process_run_events` | `ProcessRunEvent` | `app.process` | no | `process_runs.id` | `back/app/process/models.py:116` |
| `process_runs` | `ProcessRun` | `app.process` | yes | `agents.id`, `process_definitions.id`, `tasks.id` | `back/app/process/models.py:52` |
...
| `user_llm_preferences` | `UserLlmPreferences` | `app.llm` | no | `llm_profiles.id`, `llms.id`, `users.id` | `back/app/llm/profile_models.py:103` |
...
- Declared settings: 27.
- Variables in `.env.example`: 40.
- Settings without an `.env.example` entry: —.
- `.env.example` entries without a direct `Settings` field: `BROWSER_EXECUTOR_CPUS`, `BROWSER_EXECUTOR_MEMORY_LIMIT`, `DEV_DEBUGPY_PORT`, `DEV_HOST_USER_ID`, `POSTGRES_MODE`, `SSH_EXECUTOR_CPUS`, `SSH_EXECUTOR_MEMORY_LIMIT`, `TZ`, `WEBRTC_TURN_CPUS`, `WEBRTC_TURN_IMAGE`, `WEBRTC_TURN_MAX_PORT`, `WEBRTC_TURN_MEMORY_LIMIT`, `WEBRTC_TURN_MIN_PORT`.
