...
| GET | `/chat/html-previews/{ticket}` | `app.chat` | `read_standalone_html_preview` | no | `back/app/chat/router.py:291` |
| GET | `/chat/identities` | `app.chat` | `read_identity_mappings` | yes | `back/app/chat/router.py:383` |
| DELETE | `/chat/identities/{tool_id}` | `app.chat` | `delete_identity_mapping` | yes | `back/app/chat/router.py:413` |
| PUT | `/chat/identities/{tool_id}` | `app.chat` | `update_identity_mapping` | yes | `back/app/chat/router.py:392` |
| GET | `/chat/inbox` | `app.chat` | `read_inbox` | yes | `back/app/chat/router.py:325` |
| GET | `/chat/push/configuration` | `app.chat` | `read_push_configuration` | yes | `back/app/chat/router.py:331` |
