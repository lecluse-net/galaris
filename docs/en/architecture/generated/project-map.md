...
- 525 backend dependency edges;
- 192 frontend dependency edges;
- 265 edges between `app`/`bridge` domains;
...
| `app.documentation` | app | no | yes | `contracts.py`, `facade.py`, `models.py`, `tests/` |
...
| `app.lab` | app | no | yes | `contracts.py`, `i18n/`, `mcp.py`, `models.py`, `privileges.py`, `router.py`, `schemas.py`, `tests/` |
...
| POST | `/harnesses/agents/{id}/actions/{action}` | `app.harnesses` | `run_harness_action` | yes | `back/app/harnesses/router.py:338` |
| GET | `/harnesses/agents/{id}/logs` | `app.harness` | `harness_logs` | yes | `back/app/harness/router.py:74` |
| GET | `/harnesses/agents/{id}/logs` | `app.harnesses` | `harness_logs` | yes | `back/app/harnesses/router.py:367` |
...
| GET | `/llm-calls` | `app.llm` | `read_calls` | yes | `back/app/llm/call_router.py:437` |
| DELETE | `/llm-calls/cleanup` | `app.llm` | `cleanup_calls` | yes | `back/app/llm/call_router.py:507` |
...
| POST | `/llm/anthropic/v1/messages` | `app.llm` | `anthropic_messages` | no | `back/app/llm/anthropic_router.py:252` |
| POST | `/llm/anthropic/v1/messages/count_tokens` | `app.llm` | `anthropic_count_tokens` | no | `back/app/llm/anthropic_router.py:218` |
| GET | `/llm/anthropic/v1/models` | `app.llm` | `anthropic_models` | no | `back/app/llm/anthropic_router.py:184` |
...
| POST | `/llm/openai/chat/completions` | `app.llm` | `llm_completion` | no | `back/app/llm/call_router.py:203` |
| POST | `/llm/openai/inferences` | `app.llm` | `create_inference` | no | `back/app/llm/call_router.py:116` |
| GET | `/llm/openai/inferences/{inference_id}` | `app.llm` | `get_inference` | no | `back/app/llm/call_router.py:140` |
| POST | `/llm/openai/inferences/{inference_id}/commands` | `app.llm` | `command_inference` | no | `back/app/llm/call_router.py:146` |
| GET | `/llm/openai/inferences/{inference_id}/events` | `app.llm` | `inference_events` | no | `back/app/llm/call_router.py:160` |
| GET | `/llm/openai/models` | `app.llm` | `llm_models` | no | `back/app/llm/call_router.py:183` |
| POST | `/llm/openai/responses` | `app.llm` | `llm_responses` | no | `back/app/llm/call_router.py:327` |
| POST | `/llm/openai/responses/compact` | `app.llm` | `llm_responses` | no | `back/app/llm/call_router.py:327` |
| GET | `/llm/openai/runs/{agent_run_id}/usage` | `app.llm` | `llm_run_usage` | no | `back/app/llm/call_router.py:419` |
...
| POST | `/profile/anthropic/v1/messages` | `app.llm` | `anthropic_messages` | no | `back/app/llm/anthropic_router.py:252` |
| POST | `/profile/anthropic/v1/messages/count_tokens` | `app.llm` | `anthropic_count_tokens` | no | `back/app/llm/anthropic_router.py:218` |
| GET | `/profile/anthropic/v1/models` | `app.llm` | `anthropic_models` | no | `back/app/llm/anthropic_router.py:184` |
| POST | `/profile/decisions` | `app.llm` | `decisions` | no | `back/app/llm/profile_inference_router.py:52` |
| GET | `/profile/models` | `app.llm` | `models` | no | `back/app/llm/profile_inference_router.py:28` |
| POST | `/profile/openai/chat/completions` | `app.llm` | `llm_completion` | no | `back/app/llm/call_router.py:203` |
| POST | `/profile/openai/embeddings` | `app.llm` | `embeddings` | no | `back/app/llm/profile_inference_router.py:35` |
| GET | `/profile/openai/models` | `app.llm` | `llm_models` | no | `back/app/llm/call_router.py:183` |
| POST | `/profile/openai/responses` | `app.llm` | `llm_responses` | no | `back/app/llm/call_router.py:327` |
| POST | `/profile/openai/responses/compact` | `app.llm` | `llm_responses` | no | `back/app/llm/call_router.py:327` |
...
| `lab_agent_reviews` | `LabAgentReview` | `app.lab` | yes | `agents.id`, `lab_evaluation_run_cases.id`, `lab_judgment_campaigns.id`, `tasks.id` | `back/app/lab/models.py:425` |
| `lab_commands` | `LabCommand` | `app.lab` | yes | `agents.id`, `tasks.id` | `back/app/lab/models.py:411` |
...
| `lab_evaluation_run_cases` | `LabEvaluationRunCase` | `app.lab` | yes | `lab_evaluation_cases.id`, `lab_evaluation_runs.id` | `back/app/lab/models.py:289` |
| `lab_evaluation_runs` | `LabEvaluationRun` | `app.lab` | yes | `agents.id`, `lab_evaluation_datasets.id`, `llms.id`, `tasks.id` | `back/app/lab/models.py:191` |
| `lab_human_reviews` | `LabHumanReview` | `app.lab` | yes | `lab_evaluation_run_cases.id`, `lab_judgment_campaigns.id`, `users.id` | `back/app/lab/models.py:389` |
| `lab_judgment_campaigns` | `LabJudgmentCampaign` | `app.lab` | yes | `lab_evaluation_runs.id`, `llms.id` | `back/app/lab/models.py:337` |
| `lab_judgment_results` | `LabJudgmentResult` | `app.lab` | yes | `lab_evaluation_run_cases.id`, `lab_judgment_campaigns.id` | `back/app/lab/models.py:364` |
| `lab_operation_results` | `LabOperationResult` | `app.lab` | yes | `process_runs.id` | `back/app/lab/models.py:440` |
...
| `llm_profiles` | `LlmProfile` | `app.llm` | no | `llms.id` | `back/app/llm/profile_models.py:19` |
