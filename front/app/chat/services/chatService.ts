...
export const chatService = {
  ...
  async tasks(roomId: string, fromMessageId: string | null | undefined, page = 1, pageSize = 10, agentId: number | null = null): Promise<ConversationTaskTree> { return (await api.get<ConversationTaskTree>(`${base}/rooms/${roomId}/tasks`, { params: { from_message_id: fromMessageId, page, page_size: pageSize, agent_id: agentId } })).data },
